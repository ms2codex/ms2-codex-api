defmodule Codex.Metadata.InventoryTab do
  @moduledoc false
...
defmodule Codex.Metadata.GemSlot do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
...
defmodule Codex.Metadata.EquipSlot do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
...
defmodule Codex.Metadata.ItemContent do
  @moduledoc false
...
defmodule Codex.Metadata.ItemFunction do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Codex.Metadata.DismantleReward do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Codex.Metadata.Item do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field :id, 1, type: :int32
  field :slot, 2, enum: true, type: Codex.Metadata.EquipSlot
  field :gem_slot, 3, enum: true, type: Codex.Metadata.GemSlot
  field :tab, 4, enum: true, type: Codex.Metadata.InventoryTab
  ...
  field :jobs, 19, enum: true, repeated: true, type: Codex.Metadata.Job
  field :content, 20, repeated: true, type: Codex.Metadata.ItemContent
  field :dismantle_rewards, 21, repeated: true, type: Codex.Metadata.DismantleReward
  field :function_data, 22, type: Codex.Metadata.ItemFunction
end

defmodule Codex.Metadata.Items do
  @moduledoc false
  use Protobuf, syntax: :proto3

  alias Codex.Metadata.Item
  ...
  def store() do
    list =
      [:code.priv_dir(:codex), "resources", "ms2-item-metadata"]
      |> Path.join()
      |> File.read!()
      |> __MODULE__.decode()
